...
1. **Checkpoints:** add each CP/SCP by its 8-digit MGR, or switch the form to **Lat/Lng** and enter decimal degrees (e.g. `1.36832, 103.65100`). They show on the map as black dots.
